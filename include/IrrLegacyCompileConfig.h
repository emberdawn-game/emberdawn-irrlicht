...
// Legacy compile configuration.
// These configuration options are being gradually migrated to CMake options.
// Once the process is complete, this file will be removed.

#ifndef __IRR_LEGACY_COMPILE_CONFIG_H_INCLUDED__
#define __IRR_LEGACY_COMPILE_CONFIG_H_INCLUDED__
